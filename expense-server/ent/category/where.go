...
func HasExpenses() predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasExpensesWith(preds ...predicate.Expense) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
...
func HasRecurringExpenses() predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasRecurringExpensesWith(preds ...predicate.RecurringExpense) predicate.Category {
	return predicate.Category(func(s *sql.Selector) {
